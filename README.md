...
* Questions: how to set the noise level according to various distributions; why knockoff+ is not that effective in my attempt; details of knockoff+'s design strategy; real application scenario to use knockoff except medical health
